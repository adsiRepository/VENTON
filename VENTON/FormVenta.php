...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="Imagenes/salescar.png"/>
    ...
    <form action="venta.php" id="FormVenta" method="post" style="height: 100%;"
        ...
        <input type="text" name="post" value="FormVenta.php" style="display:none;position:absolute;"/>
                    ...
                    <output name="total" for="valortot1 valortot2 valortot3 valortot4 
                        ...
                        <center>
                                ...
                                <input type="button" value="Cancelar" 
                                       onclick="window.location='indexAdmin.php'" class="boton"/>
